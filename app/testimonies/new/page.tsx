...
import { getCurrentUser, listPublicPrayers } from "@/lib/api";
...
export default async function NewTestimonyPage() {
  ...
  const prayers = await listPublicPrayers(0, 50, user.organization_id ?? undefined);
